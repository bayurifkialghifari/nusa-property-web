...
export const projectImages = {
  gate: {
    file: "gate",
    title: "Gerbang G-Land Padalarang Residence",
    alt: "Visualisasi gerbang masuk G-Land Padalarang Residence dengan nama proyek di atas pintu masuk",
    width: 1200,
    height: 583,
  },
  cozy: {
    ...
    alt: "Visualisasi tampak depan hunian Blok P Cozy Level di G-Land Padalarang Residence",
    width: 1200,
    height: 669,
  },
  superimposed: {
    ...
    alt: "Visualisasi tampak depan hunian Blok P Superimposed di G-Land Padalarang Residence",
    width: 1200,
    height: 675,
  },
  ebony: {
    file: "ebony",
    title: "Cluster Ebony",
    alt: "Visualisasi tampak depan hunian Cluster Ebony di G-Land Padalarang Residence",
    width: 1200,
    height: 668,
  },
  blokQ: {
    file: "blok-q",
    title: "Blok Q",
    alt: "Visualisasi tampak depan hunian Blok Q di G-Land Padalarang Residence",
    width: 1200,
    height: 675,
  },
  environment1: {
